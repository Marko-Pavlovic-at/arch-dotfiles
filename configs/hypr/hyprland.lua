...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(4fc3f7ee)", "rgba(f4a0b8bb)"}, angle = 45 },
            inactive_border = "rgba(1a2a3a99)",
        },
...
hl.bind(mainMod .. " + SHIFT + V", hl.dsp.exec_cmd("bash -c 'cliphist list | wofi --dmenu | cliphist decode | wl-copy'"))
